...
Notes:
    ...
    - CUDA training enables AMP mixed precision, pinned host memory, TF32,
      cuDNN benchmark, and non-blocking tensor transfers.
...
def main() -> int:
    ...
    loader_kwargs = _build_loader_kwargs(int(args.num_workers), runtime_device)
    ...
    scaler = GradScaler("cuda", enabled=bool(use_amp and runtime_device.use_cuda))
    ...
    config_payload = {
        ...
        "runtime_device": {
            ...
            "resolved": runtime_device.resolved,
            "amp": bool(use_amp),
        },
...
def _build_loader_kwargs(num_workers: int, runtime_device: RuntimeDevice) -> dict[str, Any]:
    kwargs: dict[str, Any] = {
